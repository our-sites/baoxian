(function($) {
	...
	//if(window.location.pathname.indexOf("/admin/bx/consult/")==0){
	//	$.getScript("/static/editor/ueditor.config.js",function(){
	//		$.getScript("/static/editor/ueditor.all.min.js",function(){
	//			$.getScript("/static/editor/lang/zh-cn/zh-cn.js",function(){
	//				//UE.getEditor($("#id_content"));
	//				$("#id_content").width("1000px");
	//				//$("#id_content").height("800px");
	//				UE.getEditor($("#id_content")[0]);
	//			})
	//		})
	//	})
    //
