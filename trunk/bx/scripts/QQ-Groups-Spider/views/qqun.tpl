...
<html>
    ...
    <body>
            ...
            <div class="alacarte">
                <form method="post" action="/qqun" onsubmit="qrLoginCheck()">
                    <p>
                        <label for="st">
                            <strong>排序方式</strong>
                            <input type="radio" id="st_4" name="st" value="4" checked="checked" />群活跃度
                            <input type="radio" id="st_2" name="st" value="2"  />群人数
                    ...
                    <p>
                        <label for="pn">
                            <strong>抓取数量</strong>
                            <input type="radio" id="pn_5" name="pn" value="5" />40&nbsp;&nbsp;
                            ...
                            <input type="radio" id="pn_20" name="pn" value="25" checked="checked" />200
                        </label>
                    </p>
                    <p>
                        <label for="ft">
                    ...
                    <p>
                        <label for="kw">
                            <strong>群关键词</strong>
                            <input type="text" id="kw" name="kw" placeholder="输入小区名,不输入默认读Mysql库" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />
                        </label>
        ...
        <a href="https://github.com/caspartse/QQ-Groups-Spider" target="_blank"><img style="position: absolute; top: 0; right: 0; border: 0;" src="" alt="Fork me on GitHub" data-canonical-src="https://s3.amazonaws.com/github/ribbons/forkme_right_green_007200.png"></a>
