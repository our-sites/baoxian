;/*!com/arale/1.2.0:aspect*/
define('com/arale/1.2.0:aspect', [], function(require, exports, module) {
...
;/*!com/arale/1.2.0:attribute*/
define('com/arale/1.2.0:attribute', [], function(require, exports, module) {
...
;/*!com/arale/1.2.0:class*/
define('com/arale/1.2.0:class', [], function(require, exports, module) {

  // 来源于arale-class 1.2.0
  // Class
  // -----------------
  // Thanks to:
...
;/*!com/arale/1.2.0:events*/
define('com/arale/1.2.0:events', [], function(require, exports, module) {

  // 来源于 arale-events 1.2.0
  // Events
  // -----------------
  // Thanks to:
...
;/*!com/arale/1.2.0:daparser*/
define('com/arale/1.2.0:daparser', ['lib/jquery/1.11.3:jquery'], function(require, exports, module) {
...
;/*!com/arale/1.2.0:widget*/
define('com/arale/1.2.0:widget', ['lib/jquery/1.11.3:jquery', 'com/arale/1.2.0:base', 'com/arale/1.2.0:daparser', 'com/arale/1.2.0:auto-render'], function(require, exports, module) {

  // 来源于 arale-widget 1.2.0
  // Widget
  // ---------
  ...
  var $ = require('lib/jquery/1.11.3:jquery')
  var Base = require('com/arale/1.2.0:base')
  var DAParser = require('com/arale/1.2.0:daparser')
  var AutoRender = require('com/arale/1.2.0:auto-render')
