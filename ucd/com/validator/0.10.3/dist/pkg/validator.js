;/*!com/validator/0.10.3:async*/
define('com/validator/0.10.3:async', [], function(require, exports, module) {
...
;/*!com/validator/0.10.3:rule*/
define('com/validator/0.10.3:rule', ['lib/jquery/1.11.3:jquery'], function(require, exports, module) {
...
;/*!com/validator/0.10.3:item*/
define('com/validator/0.10.3:item', ['lib/jquery/1.11.3:jquery', 'com/validator/0.10.3:utils', 'com/arale/1.2.0:widget', 'com/validator/0.10.3:async', 'com/validator/0.10.3:rule'], function(require, exports, module) {

  var $ = require('lib/jquery/1.11.3:jquery'),
      utils = require('com/validator/0.10.3:utils'),
      Widget = require('com/arale/1.2.0:widget'),
      async = require('com/validator/0.10.3:async'),
      Rule = require('com/validator/0.10.3:rule');
...
;/*!com/validator/0.10.3:core*/
define('com/validator/0.10.3:core', ['lib/jquery/1.11.3:jquery', 'com/validator/0.10.3:async', 'com/arale/1.2.0:widget', 'com/validator/0.10.3:utils', 'com/validator/0.10.3:item', 'com/validator/0.10.3:rule'], function(require, exports, module) {

  var $ = require('lib/jquery/1.11.3:jquery'),
      async = require('com/validator/0.10.3:async'),
      Widget = require('com/arale/1.2.0:widget'),
      utils = require('com/validator/0.10.3:utils'),
      Item = require('com/validator/0.10.3:item');
  ...
  var Core = Widget.extend({
      ...
      Statics: $.extend({helper: utils.helper}, require('com/validator/0.10.3:rule'), {
...
;/*!com/validator/0.10.3:validator*/
define('com/validator/0.10.3:validator', ['com/validator/0.10.3:core', 'lib/jquery/1.11.3:jquery'], function(require, exports, module) {

  var Core = require('com/validator/0.10.3:core'),
      $ = require('lib/jquery/1.11.3:jquery');
