...
package com.common.insurance.widget;
...
import com.common.insurance.utils.MathUtil;
...
public class RoundedImageView extends ImageView {
    ...
    private final static float[] mCornerRadii =
    ...
    public void setCornerRadius(int corner, float radius) {
        if (MathUtil.floatEqual(mCornerRadii[corner], radius, 3)) {
            return;
        }
    ...
    public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
        if (MathUtil.floatEqual(mCornerRadii[0], topLeft, 3)
                && MathUtil.floatEqual(mCornerRadii[1], topRight, 3)
                && MathUtil.floatEqual(mCornerRadii[2], bottomRight, 3)
                && MathUtil.floatEqual(mCornerRadii[3], bottomLeft, 3)) {
            return;
        }
    ...
    public void setBorderWidth(float width) {
        if (MathUtil.floatEqual(mBorderWidth, width, 5)) {
            return;
        }
