...
public class JsonResponseHandler extends TextReponseHandler {
    ...
    public void onSuccess(IRequest request, int statusCode, JSONArray jsonArray) {
    }
    ...
    private void onRequestSuccess(IRequest request, int statusCode, JSONArray jsonArray) {
        onSuccess(request, statusCode, jsonArray);
    }
    ...
    public final void onSuccess(IRequest request, int statusCode, String responseContent) {
        ...
        try {
            ...
            if (jsonResponse instanceof JSONObject) {
                ...
                onRequestSuccess(request, statusCode, (JSONArray) jsonResponse);
