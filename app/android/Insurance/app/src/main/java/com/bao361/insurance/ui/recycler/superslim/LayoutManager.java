package com.bao361.insurance.ui.recycler.superslim;
...
public class LayoutManager extends RecyclerView.LayoutManager {
    ...
    public LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
        ...
        SectionLayoutManager sectionLayoutManager = getSlm(params);
...
//            attachView(header, findLastIndexForSection(sd.firstPosition) + 1);
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        private static class MissingFirstPositionException extends RuntimeException {
        ...
        private static class InvalidFirstPositionException extends RuntimeException {
    ...
    private static class NotYetImplementedSlmException extends RuntimeException {
    ...
    private static class UnknownSectionLayoutException extends RuntimeException {
